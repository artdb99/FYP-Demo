...
pc = Pinecone(api_key="pcsk_6y2Ais_RUETFpDEyBvMEXTjmvvBMnv7bcvQnDSvxqbbxoiQvvRUcavycMEdf14THtgy4ZG")
...
def generate_rag_response(user_query):
    ...
    try:
        ...
        client = OpenAI(
            api_key= "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",
