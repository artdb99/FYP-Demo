    ...
    <div className="max-w-7xl mx-auto px-6 py-10 space-y-6">
      ...
      <header className="bg-gradient-to-r from-teal-500 to-green-500 text-white py-6 px-6 rounded-lg shadow-md flex justify-between items-center">
        ...
        <Link
          ...
          className="bg-white text-purple-700 px-4 py-2 rounded shadow hover:bg-gray-100 transition"
        >
          + Create Patient
        </Link>
      </header>

      {/* Patient List (hideHeader prop hides the blue header inside PatientsList) */}
