...
import { User, Lock, Save, Shield, Trash2, AlertTriangle } from 'lucide-react';
    ...
    <div className="w-full px-6 md:px-8 lg:px-10 py-6 space-y-6">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">Manage system and account preferences</p>
        </div>
      </div>
      ...
      {/* Profile Settings */}
      <Card className="rounded-2xl bg-white shadow-md ring-1 ring-purple-100/60 px-6 py-5">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-purple-300"
            />
          </div>
          <div>
